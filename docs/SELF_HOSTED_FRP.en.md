...
This page covers the released managed deployment, in which the plugin installs frps and Caddy. Attaching to an frps you already operate is **unreleased**; the published 0.4.5 plugin and app do not contain that entry. See [Attach to an existing frps](ATTACH_EXISTING_FRPS.en.md) for the development guide.
