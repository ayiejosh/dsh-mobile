...
本页介绍已发布的托管部署（插件安装 frps 与 Caddy）。接入你已运行的 frps 属于 **0.4.6 候选版**，尚未发布；线上 0.4.5 插件和 App 不提供该入口。
...
本页的公开证书入口需要 Android App 0.3.3 或更高版本（远程自定义入口）。0.4.6 候选版的自签穿透档需要 0.4.6 Android App 固定远程 CA，已发布的 0.4.5 及更早 App 不支持该档。旧版 App 仍可使用局域网、cpolar 和 Tailscale。
